...
mkdir -p -- "$plugin_dir"
for filename in Widget.qml manifest.json viewport.mjs native-preview.mjs preview-host.mjs phone-remote.mjs phone-firewall.mjs viewer.html linked-previews.mjs sync-policy.mjs sync.js devices.json README.md PLAN.md LICENSE preview.png; do
